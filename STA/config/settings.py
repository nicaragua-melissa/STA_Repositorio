...
SECRET_KEY = "django-insecure-pqg4e!upz=f_1c3_cf+6yf-!-@ti$gm_zpsx$8uh1djvz215v*"
...
DATABASES = {
    'default': {
        ...
        'NAME': 'STADB',  # Nombre de la base de datos
        'HOST': 'GWNR71517',  # IP del servidor SQL Server
        'OPTIONS': {
...
# Crea JWT
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=5),  # Token de 2 minutos
